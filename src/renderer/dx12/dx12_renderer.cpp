...
void cg::renderer::dx12_renderer::load_pipeline()
{
	...
	THROW_IF_FAILED(dxgi_factory->CreateSwapChainForHwnd(command_queue.Get(), cg::utils::window::get_hwnd(), &swap_chain_desc, nullptr, nullptr, &temp_swap_chain));
...
void cg::renderer::dx12_renderer::load_assets()
{
	...
	D3D12_INPUT_ELEMENT_DESC input_element_descriptors[] = {
		...
		{ "COLOR", 1, DXGI_FORMAT_R32G32B32_FLOAT, 0, 32,
		  D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA },
